...
#java -javaagent:./javaAgent/build/libs/javaAgent.jar=log:DEBUG,filter:TestFiltersC#new -jar ./javaExampleApp/build/libs/javaExampleApp.jar
#java "-javaagent:./javaAgent/build/libs/javaAgent.jar=log:DEBUG,filter:TestFiltersC#(new||functionDEF)" -jar ./javaExampleApp/build/libs/javaExampleApp.jar
